...
.method public constructor <init>(Landroid/content/Context;Landroid/content/res/Resources;Landroid/os/storage/StorageVolume;Landroid/os/storage/StorageManager;Z)V
    ...
    .line 66
    iput-boolean v1, p0, Lcom/android/settings/deviceinfo/StorageVolumePreferenceCategory;->mIsAllowed:Z
...
.method private updatePreferencesFromState()V
    ...
    iget-boolean v2, p0, Lcom/android/settings/deviceinfo/StorageVolumePreferenceCategory;->mIsAllowed:Z
...
.method public init()V
    ...
    const-string v7, "mot_device_policy"

    invoke-virtual {v6, v7}, Landroid/content/Context;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;

    move-result-object v6

    check-cast v6, Lcom/motorola/motepm/MotDevicePolicyManager;

    iput-object v6, p0, Lcom/android/settings/deviceinfo/StorageVolumePreferenceCategory;->mDPM:Lcom/motorola/motepm/MotDevicePolicyManager;

    .line 201
    iget-object v6, p0, Lcom/android/settings/deviceinfo/StorageVolumePreferenceCategory;->mDPM:Lcom/motorola/motepm/MotDevicePolicyManager;
    ...
    iput-boolean v6, p0, Lcom/android/settings/deviceinfo/StorageVolumePreferenceCategory;->mIsAllowed:Z
    ...
    invoke-direct {p0, v6}, Lcom/android/settings/deviceinfo/StorageVolumePreferenceCategory;->isUsbDisk(Landroid/os/storage/StorageVolume;)Z
...
.method public updateApproximate(JJ)V
    ...
    .line 358
    .local v2, "usedSize":J
    iget-object v5, p0, Lcom/android/settings/deviceinfo/StorageVolumePreferenceCategory;->mUsageBarPreference:Lcom/android/settings/deviceinfo/UsageBarPreference;

    invoke-virtual {v5}, Lcom/android/settings/deviceinfo/UsageBarPreference;->clear()V
    ...
    invoke-virtual {v5, v6, v7}, Lcom/android/settings/deviceinfo/UsageBarPreference;->addEntry(FI)V

    .line 360
    iget-object v5, p0, Lcom/android/settings/deviceinfo/StorageVolumePreferenceCategory;->mUsageBarPreference:Lcom/android/settings/deviceinfo/UsageBarPreference;

    invoke-virtual {v5}, Lcom/android/settings/deviceinfo/UsageBarPreference;->commit()V
    ...
    .line 376
    .end local v0    # "isInternalStorage":Z
    :cond_2
    return-void
