...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/android/settings/bluetooth/LocalBluetoothProfileManager$DUNStateChangedHandler;,
...
.field private mDUNProfile:Lcom/android/settings/bluetooth/DUNProfile;
...
.method constructor <init>(Landroid/content/Context;Lcom/android/settings/bluetooth/LocalBluetoothAdapter;Lcom/android/settings/bluetooth/CachedBluetoothDeviceManager;Lcom/android/settings/bluetooth/BluetoothEventManager;)V
    ...
    .line 125
    new-instance v1, Lcom/android/settings/bluetooth/DUNProfile;

    invoke-direct {v1}, Lcom/android/settings/bluetooth/DUNProfile;-><init>()V

    iput-object v1, p0, Lcom/android/settings/bluetooth/LocalBluetoothProfileManager;->mDUNProfile:Lcom/android/settings/bluetooth/DUNProfile;

    .line 126
    iget-object v1, p0, Lcom/android/settings/bluetooth/LocalBluetoothProfileManager;->mDUNProfile:Lcom/android/settings/bluetooth/DUNProfile;

    const-string v2, "DUN"

    const-string v3, "com.android.bluetooth.dun.statechanged"

    invoke-direct {p0, v1, v2, v3}, Lcom/android/settings/bluetooth/LocalBluetoothProfileManager;->addDUNProfile(Lcom/android/settings/bluetooth/LocalBluetoothProfile;Ljava/lang/String;Ljava/lang/String;)V
...
.method private addDUNProfile(Lcom/android/settings/bluetooth/LocalBluetoothProfile;Ljava/lang/String;Ljava/lang/String;)V
    .locals 2
    ...
    new-instance v1, Lcom/android/settings/bluetooth/LocalBluetoothProfileManager$DUNStateChangedHandler;

    invoke-direct {v1, p0, p1}, Lcom/android/settings/bluetooth/LocalBluetoothProfileManager$DUNStateChangedHandler;-><init>(Lcom/android/settings/bluetooth/LocalBluetoothProfileManager;Lcom/android/settings/bluetooth/LocalBluetoothProfile;)V
    ...
    const-string v1, "Added handler for DUN state changed Notifications"
...
.method declared-synchronized updateProfiles([Landroid/os/ParcelUuid;[Landroid/os/ParcelUuid;Ljava/util/Collection;Ljava/util/Collection;)V
    ...
    sget-object v0, Landroid/bluetooth/BluetoothUuid;->HidLe:Landroid/os/ParcelUuid;
