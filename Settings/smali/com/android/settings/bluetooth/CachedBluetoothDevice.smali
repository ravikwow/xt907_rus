...
# instance fields
.field private mBtAppearance:Ljava/lang/String;
...
.method private connectWithoutResettingTimer(Z)V
    ...
    invoke-virtual {v3, v4, v5}, Lcom/android/settings/bluetooth/LocalBluetoothAdapter;->isHostPatchRequired(Landroid/bluetooth/BluetoothDevice;I)Z
    ...
    const-string v4, "No connection expected with current device"
...
.method private fetchDeviceId()V
    .locals 1
    ...
    invoke-virtual {v0}, Landroid/bluetooth/BluetoothDevice;->getBluetoothDeviceId()Ljava/lang/String;

    move-result-object v0

    iput-object v0, p0, Lcom/android/settings/bluetooth/CachedBluetoothDevice;->mDeviceId:Ljava/lang/String;
...
.method private fillData()V
    ...
    .line 369
    invoke-direct {p0}, Lcom/android/settings/bluetooth/CachedBluetoothDevice;->fetchDeviceId()V
...
.method getBtIconAppearance()Ljava/lang/String;
    .locals 1

    .prologue
    .line 612
    iget-object v0, p0, Lcom/android/settings/bluetooth/CachedBluetoothDevice;->mBtAppearance:Ljava/lang/String;
...
.method public getDeviceId()Ljava/lang/String;
    ...
    .prologue
    .line 384
    iget-object v0, p0, Lcom/android/settings/bluetooth/CachedBluetoothDevice;->mDeviceId:Ljava/lang/String;
...
.method onProfileStateChanged(Lcom/android/settings/bluetooth/LocalBluetoothProfile;I)V
    ...
    instance-of v0, p1, Lcom/android/settings/bluetooth/DUNProfile;
    ...
    const-string v1, "Removed Profile from the list"
...
.method public resetAllServerProfiles()V
    ...
    .line 187
    check-cast v2, Lcom/android/settings/bluetooth/SapProfile;

    invoke-virtual {v2, v3}, Lcom/android/settings/bluetooth/SapProfile;->setConnectionStatus(I)V

    .line 189
    :cond_1
    instance-of v2, v1, Lcom/android/settings/bluetooth/DUNProfile;
    ...
    .end local v1    # "profile":Lcom/android/settings/bluetooth/LocalBluetoothProfile;
    invoke-virtual {v1, v3}, Lcom/android/settings/bluetooth/DUNProfile;->setConnectionStatus(I)V
...
.method setBtIconAppearance(Ljava/lang/String;)V
    .locals 0
    ...
    .line 606
    iput-object p1, p0, Lcom/android/settings/bluetooth/CachedBluetoothDevice;->mBtAppearance:Ljava/lang/String;
...
.method setDeviceId(Ljava/lang/String;)V
    ...
    .prologue
    .line 460
    iput-object p1, p0, Lcom/android/settings/bluetooth/CachedBluetoothDevice;->mDeviceId:Ljava/lang/String;
