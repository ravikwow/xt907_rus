...
.method private changeSDEncryptionSettings()V
    ...
    invoke-virtual {p0, v1}, Lcom/android/settings/sdencryption/EncryptionServerActivity;->showDialog(I)V
    ...
    .line 201
    invoke-virtual {p0}, Lcom/android/settings/sdencryption/EncryptionServerActivity;->getApplicationContext()Landroid/content/Context;
...
.method private changeSDEncryptionSettingsDirectly()V
    ...
    invoke-virtual {p0, v1}, Lcom/android/settings/sdencryption/EncryptionServerActivity;->sendBroadcast(Landroid/content/Intent;)V
...
.method private checkEncryptionSyncStatus()V
    ...
    invoke-virtual {p0, v0}, Lcom/android/settings/sdencryption/EncryptionServerActivity;->showDialog(I)V
...
.method private runOnCreate()V
    ...
    .line 77
    invoke-virtual {p0}, Lcom/android/settings/sdencryption/EncryptionServerActivity;->getWindow()Landroid/view/Window;
...
.method private runOnResume()V
    ...
    .line 108
    invoke-virtual {p0, v1}, Lcom/android/settings/sdencryption/EncryptionServerActivity;->removeDialog(I)V
...
.method private selfClose()V
    ...
    .line 477
    :cond_0
    invoke-virtual {p0}, Lcom/android/settings/sdencryption/EncryptionServerActivity;->finish()V
...
.method doBindService()V
    ...
    invoke-virtual {p0, v0, v1, v2}, Lcom/android/settings/sdencryption/EncryptionServerActivity;->bindService(Landroid/content/Intent;Landroid/content/ServiceConnection;I)Z
...
.method doUnbindService()V
    ...
    invoke-virtual {p0, v0}, Lcom/android/settings/sdencryption/EncryptionServerActivity;->unbindService(Landroid/content/ServiceConnection;)V
...
.method protected onCreateDialog(I)Landroid/app/Dialog;
    ...
    invoke-virtual {p0, v3}, Lcom/android/settings/sdencryption/EncryptionServerActivity;->getString(I)Ljava/lang/String;
    ...
    .line 377
    invoke-virtual {v1, p0}, Landroid/app/ProgressDialog;->setOnKeyListener(Landroid/content/DialogInterface$OnKeyListener;)V
...
.method public onSDEncrStatusChange()V
    ...
    invoke-virtual {p0, v0}, Lcom/android/settings/sdencryption/EncryptionServerActivity;->runOnUiThread(Ljava/lang/Runnable;)V
