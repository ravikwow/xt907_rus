...
.method private initUninstallButtons()V
    ...
    :goto_0
    iput-boolean v11, p0, Lcom/android/settings/applications/InstalledAppDetails;->mUpdatedSysApp:Z
    ...
    .line 312
    .local v4, "enabled":Z
    iget-boolean v11, p0, Lcom/android/settings/applications/InstalledAppDetails;->mUpdatedSysApp:Z
    ...
    const-string v13, "demo_mode_enabled"
    ...
    .line 356
    :cond_1
    const-string v11, "/system/etc/motorola/nondispackages.txt"

    invoke-static {v11}, Lcom/android/settings/Utils;->getFileInSystem(Ljava/lang/String;)Ljava/io/File;

    move-result-object v2

    .line 358
    .local v2, "disableExceptionPackagesFile":Ljava/io/File;
    const/4 v5, 0x0
    ...
    .line 310
    .end local v0    # "dis":Ljava/io/DataInputStream;
    .end local v2    # "disableExceptionPackagesFile":Ljava/io/File;
    ...
    .restart local v7    # "homes":Ljava/util/List;, "Ljava/util/List<Landroid/content/pm/ResolveInfo;>;"
    .restart local v8    # "intent":Landroid/content/Intent;
    .restart local v10    # "sys":Landroid/content/pm/PackageInfo;
    :cond_b
    :try_start_6
    iget-object v11, p0, Lcom/android/settings/applications/InstalledAppDetails;->mAppEntry:Lcom/android/settings/applications/ApplicationsState$AppEntry;
    ...
    .restart local v2    # "disableExceptionPackagesFile":Ljava/io/File;
    ...
    const-string v13, "Exception reading "
...
.method private refreshUi()Z
    ...
    invoke-virtual {v1, v0, v7, v2}, Landroid/content/pm/PackageManager;->getPreferredActivities(Ljava/util/List;Ljava/util/List;Ljava/lang/String;)I
    ...
    invoke-virtual {v0, v2}, Landroid/nfc/NfcAdapter;->hasDefaults(Ljava/lang/String;)Z
    ...
    invoke-direct {v3, v7}, Landroid/text/style/BulletSpan;-><init>(I)V

    invoke-interface {v5}, Ljava/lang/CharSequence;->length()I

    move-result v5

    invoke-virtual {v8, v3, v4, v5, v4}, Landroid/text/SpannableString;->setSpan(Ljava/lang/Object;III)V
