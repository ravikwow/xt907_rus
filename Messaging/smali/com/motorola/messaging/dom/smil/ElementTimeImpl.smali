.class public abstract Lcom/motorola/messaging/dom/smil/ElementTimeImpl;
...
.method constructor <init>(Lorg/w3c/dom/smil/SMILElement;)V
    ...
    .line 47
    iput-object p1, p0, Lcom/motorola/messaging/dom/smil/ElementTimeImpl;->mSmilElement:Lorg/w3c/dom/smil/SMILElement;
...
.method public getBegin()Lorg/w3c/dom/smil/TimeList;
    ...
    .prologue
    .line 71
    iget-object v3, p0, Lcom/motorola/messaging/dom/smil/ElementTimeImpl;->mSmilElement:Lorg/w3c/dom/smil/SMILElement;
    ...
    .line 78
    :try_start_0
    new-instance v3, Lcom/motorola/messaging/dom/smil/TimeImpl;

    aget-object v4, v1, v2

    invoke-virtual {p0}, Lcom/motorola/messaging/dom/smil/ElementTimeImpl;->getBeginConstraints()I

    move-result v5

    invoke-direct {v3, v4, v5}, Lcom/motorola/messaging/dom/smil/TimeImpl;-><init>(Ljava/lang/String;I)V
    ...
    .line 105
    :cond_1
    new-instance v3, Lcom/motorola/messaging/dom/smil/TimeListImpl;

    invoke-direct {v3, v0}, Lcom/motorola/messaging/dom/smil/TimeListImpl;-><init>(Ljava/util/ArrayList;)V
...
.method public getDur()F
    ...
    .local v0, "dur":F
    :try_start_0
    iget-object v2, p0, Lcom/motorola/messaging/dom/smil/ElementTimeImpl;->mSmilElement:Lorg/w3c/dom/smil/SMILElement;
    ...
    .line 113
    invoke-static {v1}, Lcom/motorola/messaging/dom/smil/TimeImpl;->parseClockValue(Ljava/lang/String;)F
    :try_end_0
    .catch Ljava/lang/IllegalArgumentException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public getEnd()Lorg/w3c/dom/smil/TimeList;
    ...
    iget-object v7, p0, Lcom/motorola/messaging/dom/smil/ElementTimeImpl;->mSmilElement:Lorg/w3c/dom/smil/SMILElement;
    ...
    .line 130
    :try_start_0
    new-instance v7, Lcom/motorola/messaging/dom/smil/TimeImpl;

    aget-object v8, v4, v5

    invoke-virtual {p0}, Lcom/motorola/messaging/dom/smil/ElementTimeImpl;->getEndConstraints()I

    move-result v9

    invoke-direct {v7, v8, v9}, Lcom/motorola/messaging/dom/smil/TimeImpl;-><init>(Ljava/lang/String;I)V
    ...
    .line 142
    invoke-virtual {p0}, Lcom/motorola/messaging/dom/smil/ElementTimeImpl;->getDur()F
    ...
    :cond_2
    new-instance v7, Lcom/motorola/messaging/dom/smil/TimeListImpl;

    invoke-direct {v7, v3}, Lcom/motorola/messaging/dom/smil/TimeListImpl;-><init>(Ljava/util/ArrayList;)V
    ...
    :cond_3
    invoke-virtual {p0}, Lcom/motorola/messaging/dom/smil/ElementTimeImpl;->getBegin()Lorg/w3c/dom/smil/TimeList;
...
.method public setDur(F)V
    ...
    .prologue
    .line 286
    iget-object v0, p0, Lcom/motorola/messaging/dom/smil/ElementTimeImpl;->mSmilElement:Lorg/w3c/dom/smil/SMILElement;
