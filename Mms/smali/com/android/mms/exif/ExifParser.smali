...
.method private constructor <init>(Ljava/io/InputStream;ILcom/android/mms/exif/ExifInterface;)V
    ...
    .param p2, "options"    # I
    .param p3, "iRef"    # Lcom/android/mms/exif/ExifInterface;
    ...
    iput-object v2, p0, Lcom/android/mms/exif/ExifParser;->mCorrespondingEvent:Ljava/util/TreeMap;
    ...
    iput-boolean v2, p0, Lcom/android/mms/exif/ExifParser;->mContainExifData:Z

    .line 211
    new-instance v2, Lcom/android/mms/exif/CountedDataInputStream;

    invoke-direct {v2, p1}, Lcom/android/mms/exif/CountedDataInputStream;-><init>(Ljava/io/InputStream;)V

    iput-object v2, p0, Lcom/android/mms/exif/ExifParser;->mTiffStream:Lcom/android/mms/exif/CountedDataInputStream;

    .line 212
    iput p2, p0, Lcom/android/mms/exif/ExifParser;->mOptions:I

    .line 213
    iget-boolean v2, p0, Lcom/android/mms/exif/ExifParser;->mContainExifData:Z
    ...
    invoke-virtual {v2}, Lcom/android/mms/exif/CountedDataInputStream;->readUnsignedInt()J
    ...
    invoke-direct {v2, v3}, Lcom/android/mms/exif/ExifInvalidFormatException;-><init>(Ljava/lang/String;)V
    ...
    iput-object v2, p0, Lcom/android/mms/exif/ExifParser;->mDataAboveIfd0:[B

    .line 228
    iget-object v2, p0, Lcom/android/mms/exif/ExifParser;->mDataAboveIfd0:[B

    invoke-virtual {p0, v2}, Lcom/android/mms/exif/ExifParser;->read([B)I
...
.method private checkAllowed(II)Z
    ...
    invoke-virtual {v1}, Lcom/android/mms/exif/ExifInterface;->getTagInfo()Landroid/util/SparseIntArray;
...
.method private checkOffsetOrImageTag(Lcom/android/mms/exif/ExifTag;)V
    ...
    invoke-direct {p0, v1, v3}, Lcom/android/mms/exif/ExifParser;->checkAllowed(II)Z
    ...
    .line 594
    invoke-direct {p0, v7}, Lcom/android/mms/exif/ExifParser;->isIfdRequested(I)Z
    ...
    .line 596
    :cond_2
    invoke-virtual {p1, v6}, Lcom/android/mms/exif/ExifTag;->getValueAt(I)J

    move-result-wide v3

    invoke-direct {p0, v7, v3, v4}, Lcom/android/mms/exif/ExifParser;->registerIfd(IJ)V
    ...
    .line 599
    invoke-direct {p0, v8}, Lcom/android/mms/exif/ExifParser;->isIfdRequested(I)Z
    ...
    invoke-direct {p0, v8, v3, v4}, Lcom/android/mms/exif/ExifParser;->registerIfd(IJ)V
    ...
    invoke-direct {p0, v5, v3, v4}, Lcom/android/mms/exif/ExifParser;->registerIfd(IJ)V
    ...
    invoke-direct {p0, v3, v4}, Lcom/android/mms/exif/ExifParser;->registerCompressedImage(J)V
    ...
    invoke-direct {p0, v0, v3, v4}, Lcom/android/mms/exif/ExifParser;->registerUncompressedStrip(IJ)V
    ...
    .end local v0    # "i":I
    :cond_9
    iget-object v3, p0, Lcom/android/mms/exif/ExifParser;->mCorrespondingEvent:Ljava/util/TreeMap;
    ...
    new-instance v5, Lcom/android/mms/exif/ExifParser$ExifTagEvent;

    invoke-direct {v5, p1, v6}, Lcom/android/mms/exif/ExifParser$ExifTagEvent;-><init>(Lcom/android/mms/exif/ExifTag;Z)V
    ...
    .line 631
    :cond_a
    sget-short v3, Lcom/android/mms/exif/ExifParser;->TAG_STRIP_BYTE_COUNTS:S

    if-ne v2, v3, :cond_0

    sget v3, Lcom/android/mms/exif/ExifInterface;->TAG_STRIP_BYTE_COUNTS:I
...
.method private parseTiffHeader()V
    ...
    invoke-virtual {v1}, Lcom/android/mms/exif/CountedDataInputStream;->readShort()S
    ...
    invoke-virtual {v1, v2}, Lcom/android/mms/exif/CountedDataInputStream;->setByteOrder(Ljava/nio/ByteOrder;)V
    ...
    .line 749
    new-instance v1, Lcom/android/mms/exif/ExifInvalidFormatException;

    const-string v2, "Invalid TIFF header"

    invoke-direct {v1, v2}, Lcom/android/mms/exif/ExifInvalidFormatException;-><init>(Ljava/lang/String;)V
...
.method private readTag()Lcom/android/mms/exif/ExifTag;
    ...
    invoke-virtual {v3}, Lcom/android/mms/exif/CountedDataInputStream;->readUnsignedInt()J
    ...
    .line 538
    new-instance v3, Lcom/android/mms/exif/ExifInvalidFormatException;

    const-string v4, "Number of component is larger then Integer.MAX_VALUE"

    invoke-direct {v3, v4}, Lcom/android/mms/exif/ExifInvalidFormatException;-><init>(Ljava/lang/String;)V
    ...
    invoke-virtual {v3, v4, v5}, Lcom/android/mms/exif/CountedDataInputStream;->skip(J)J
    ...
    .line 550
    .local v0, "tag":Lcom/android/mms/exif/ExifTag;
    ...
    .line 548
    .end local v0    # "tag":Lcom/android/mms/exif/ExifTag;
    ...
    .line 559
    .restart local v0    # "tag":Lcom/android/mms/exif/ExifTag;
    .restart local v7    # "dataSize":I
    .restart local v11    # "offset":J
    :cond_3
    iget-object v3, p0, Lcom/android/mms/exif/ExifParser;->mDataAboveIfd0:[B

    if-eqz v3, :cond_4

    iget v3, p0, Lcom/android/mms/exif/ExifParser;->mIfd0Position:I
    ...
    .line 564
    invoke-virtual {v0, v6}, Lcom/android/mms/exif/ExifTag;->setValue([B)Z
    ...
    invoke-virtual {v0, v3}, Lcom/android/mms/exif/ExifTag;->setOffset(I)V
    ...
    invoke-virtual {v0, v3}, Lcom/android/mms/exif/ExifTag;->setHasDefinedCount(Z)V

    .line 573
    invoke-virtual {p0, v0}, Lcom/android/mms/exif/ExifParser;->readFullTagValue(Lcom/android/mms/exif/ExifTag;)V

    .line 574
    invoke-virtual {v0, v8}, Lcom/android/mms/exif/ExifTag;->setHasDefinedCount(Z)V
...
.method private seekTiffData(Ljava/io/InputStream;)Z
    ...
    .line 756
    .local v0, "dataStream":Lcom/android/mms/exif/CountedDataInputStream;
    ...
    .line 757
    new-instance v5, Lcom/android/mms/exif/ExifInvalidFormatException;

    const-string v6, "Invalid JPEG format"

    invoke-direct {v5, v6}, Lcom/android/mms/exif/ExifInvalidFormatException;-><init>(Ljava/lang/String;)V
    ...
    invoke-static {v4}, Lcom/android/mms/exif/JpegHeader;->isSofMarker(S)Z
    ...
    iput v5, p0, Lcom/android/mms/exif/ExifParser;->mTiffStartPosition:I

    .line 775
    iput v3, p0, Lcom/android/mms/exif/ExifParser;->mApp1End:I

    .line 776
    iget v5, p0, Lcom/android/mms/exif/ExifParser;->mTiffStartPosition:I

    iget v6, p0, Lcom/android/mms/exif/ExifParser;->mApp1End:I

    add-int/2addr v5, v6

    iput v5, p0, Lcom/android/mms/exif/ExifParser;->mOffsetToApp1EndFromSOF:I
    ...
    invoke-virtual {v0, v8, v9}, Lcom/android/mms/exif/CountedDataInputStream;->skip(J)J
...
.method private skipTo(I)V
    ...
    invoke-virtual {v0, v1, v2}, Lcom/android/mms/exif/CountedDataInputStream;->skipTo(J)V
...
.method protected next()I
    ...
    .line 272
    iget-boolean v11, p0, Lcom/android/mms/exif/ExifParser;->mContainExifData:Z
    ...
    .line 275
    :cond_1
    iget-object v11, p0, Lcom/android/mms/exif/ExifParser;->mTiffStream:Lcom/android/mms/exif/CountedDataInputStream;

    invoke-virtual {v11}, Lcom/android/mms/exif/CountedDataInputStream;->getReadByteCount()I

    move-result v6

    .line 276
    .local v6, "offset":I
    iget v11, p0, Lcom/android/mms/exif/ExifParser;->mIfdStartOffset:I

    add-int/lit8 v11, v11, 0x2

    iget v12, p0, Lcom/android/mms/exif/ExifParser;->mNumOfTagInIfd:I
    ...
    iput-object v10, p0, Lcom/android/mms/exif/ExifParser;->mTag:Lcom/android/mms/exif/ExifTag;

    .line 279
    iget-object v10, p0, Lcom/android/mms/exif/ExifParser;->mTag:Lcom/android/mms/exif/ExifTag;
    ...
    .line 282
    :cond_2
    iget-boolean v10, p0, Lcom/android/mms/exif/ExifParser;->mNeedToParseOffsetsInCurrentIfd:Z
    ...
    invoke-direct {p0, v10}, Lcom/android/mms/exif/ExifParser;->checkOffsetOrImageTag(Lcom/android/mms/exif/ExifTag;)V
    ...
    .line 288
    iget v11, p0, Lcom/android/mms/exif/ExifParser;->mIfdType:I
    ...
    invoke-direct {p0, v9}, Lcom/android/mms/exif/ExifParser;->isIfdRequested(I)Z
    ...
    .line 292
    invoke-direct {p0, v9, v4, v5}, Lcom/android/mms/exif/ExifParser;->registerIfd(IJ)V

    .line 312
    .end local v4    # "ifdOffset":J
    :cond_5
    :goto_1
    iget-object v9, p0, Lcom/android/mms/exif/ExifParser;->mCorrespondingEvent:Ljava/util/TreeMap;
    ...
    invoke-direct {p0, v9}, Lcom/android/mms/exif/ExifParser;->skipTo(I)V
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0

    .line 322
    instance-of v9, v3, Lcom/android/mms/exif/ExifParser$IfdEvent;
    ...
    .line 323
    check-cast v9, Lcom/android/mms/exif/ExifParser$IfdEvent;

    iget v9, v9, Lcom/android/mms/exif/ExifParser$IfdEvent;->ifd:I

    iput v9, p0, Lcom/android/mms/exif/ExifParser;->mIfdType:I

    .line 324
    iget-object v9, p0, Lcom/android/mms/exif/ExifParser;->mTiffStream:Lcom/android/mms/exif/CountedDataInputStream;

    invoke-virtual {v9}, Lcom/android/mms/exif/CountedDataInputStream;->readUnsignedShort()I

    move-result v9

    iput v9, p0, Lcom/android/mms/exif/ExifParser;->mNumOfTagInIfd:I
    ...
    iput v9, p0, Lcom/android/mms/exif/ExifParser;->mIfdStartOffset:I

    .line 327
    iget v9, p0, Lcom/android/mms/exif/ExifParser;->mNumOfTagInIfd:I
    ...
    iget v11, p0, Lcom/android/mms/exif/ExifParser;->mApp1End:I
    ...
    iget v12, p0, Lcom/android/mms/exif/ExifParser;->mIfdType:I
    ...
    iput-boolean v9, p0, Lcom/android/mms/exif/ExifParser;->mNeedToParseOffsetsInCurrentIfd:Z

    .line 333
    check-cast v3, Lcom/android/mms/exif/ExifParser$IfdEvent;

    .end local v3    # "event":Ljava/lang/Object;
    iget-boolean v9, v3, Lcom/android/mms/exif/ExifParser$IfdEvent;->isRequested:Z
    ...
    .restart local v3    # "event":Ljava/lang/Object;
    :cond_b
    instance-of v9, v3, Lcom/android/mms/exif/ExifParser$ImageEvent;

    if-eqz v9, :cond_c

    .line 339
    check-cast v3, Lcom/android/mms/exif/ExifParser$ImageEvent;

    .end local v3    # "event":Ljava/lang/Object;
    iput-object v3, p0, Lcom/android/mms/exif/ExifParser;->mImageEvent:Lcom/android/mms/exif/ExifParser$ImageEvent;

    .line 340
    iget-object v9, p0, Lcom/android/mms/exif/ExifParser;->mImageEvent:Lcom/android/mms/exif/ExifParser$ImageEvent;

    iget v9, v9, Lcom/android/mms/exif/ExifParser$ImageEvent;->type:I
    ...
    .line 342
    check-cast v8, Lcom/android/mms/exif/ExifParser$ExifTagEvent;

    .line 343
    .local v8, "tagEvent":Lcom/android/mms/exif/ExifParser$ExifTagEvent;
    iget-object v9, v8, Lcom/android/mms/exif/ExifParser$ExifTagEvent;->tag:Lcom/android/mms/exif/ExifTag;

    iput-object v9, p0, Lcom/android/mms/exif/ExifParser;->mTag:Lcom/android/mms/exif/ExifTag;

    .line 344
    iget-object v9, p0, Lcom/android/mms/exif/ExifParser;->mTag:Lcom/android/mms/exif/ExifTag;

    invoke-virtual {v9}, Lcom/android/mms/exif/ExifTag;->getDataType()S
    ...
    invoke-virtual {p0, v9}, Lcom/android/mms/exif/ExifParser;->readFullTagValue(Lcom/android/mms/exif/ExifTag;)V

    .line 346
    iget-object v9, p0, Lcom/android/mms/exif/ExifParser;->mTag:Lcom/android/mms/exif/ExifTag;

    invoke-direct {p0, v9}, Lcom/android/mms/exif/ExifParser;->checkOffsetOrImageTag(Lcom/android/mms/exif/ExifTag;)V

    .line 348
    :cond_d
    iget-boolean v9, v8, Lcom/android/mms/exif/ExifParser$ExifTagEvent;->isRequested:Z
    ...
    .end local v2    # "entry":Ljava/util/Map$Entry;, "Ljava/util/Map$Entry<Ljava/lang/Integer;Ljava/lang/Object;>;"
    .end local v3    # "event":Ljava/lang/Object;
    .end local v8    # "tagEvent":Lcom/android/mms/exif/ExifParser$ExifTagEvent;
    :cond_e
    move v9, v10
...
.method protected readFullTagValue(Lcom/android/mms/exif/ExifTag;)V
    ...
    .line 652
    .local v5, "size":I
    iget-object v8, p0, Lcom/android/mms/exif/ExifParser;->mCorrespondingEvent:Ljava/util/TreeMap;
    ...
    invoke-virtual {v9}, Lcom/android/mms/exif/CountedDataInputStream;->getReadByteCount()I
    ...
    instance-of v8, v2, Lcom/android/mms/exif/ExifParser$ImageEvent;
    ...
    :cond_2
    instance-of v8, v2, Lcom/android/mms/exif/ExifParser$IfdEvent;
    ...
    check-cast v2, Lcom/android/mms/exif/ExifParser$IfdEvent;

    .end local v2    # "event":Ljava/lang/Object;
    iget v10, v2, Lcom/android/mms/exif/ExifParser$IfdEvent;->ifd:I
    ...
    .line 675
    invoke-virtual {p1, v5}, Lcom/android/mms/exif/ExifTag;->forceSetComponentCount(I)V
    ...
    .restart local v2    # "event":Ljava/lang/Object;
    :cond_4
    instance-of v8, v2, Lcom/android/mms/exif/ExifParser$ExifTagEvent;
    ...
    check-cast v2, Lcom/android/mms/exif/ExifParser$ExifTagEvent;

    .end local v2    # "event":Ljava/lang/Object;
    iget-object v10, v2, Lcom/android/mms/exif/ExifParser$ExifTagEvent;->tag:Lcom/android/mms/exif/ExifTag;

    invoke-virtual {v10}, Lcom/android/mms/exif/ExifTag;->toString()Ljava/lang/String;
    ...
    invoke-virtual {p0, v8}, Lcom/android/mms/exif/ExifParser;->readString(I)Ljava/lang/String;

    move-result-object v8

    invoke-virtual {p1, v8}, Lcom/android/mms/exif/ExifTag;->setValue(Ljava/lang/String;)Z
    ...
    .line 696
    :cond_5
    invoke-virtual {p1, v7}, Lcom/android/mms/exif/ExifTag;->setValue([J)Z
    ...
    new-array v7, v8, [Lcom/android/mms/exif/Rational;

    .line 701
    .local v7, "value":[Lcom/android/mms/exif/Rational;
    const/4 v3, 0x0
    ...
    .line 704
    :cond_6
    invoke-virtual {p1, v7}, Lcom/android/mms/exif/ExifTag;->setValue([Lcom/android/mms/exif/Rational;)Z
    ...
    .end local v3    # "i":I
    .end local v4    # "n":I
    .end local v7    # "value":[Lcom/android/mms/exif/Rational;
    :pswitch_5
    invoke-virtual {p1}, Lcom/android/mms/exif/ExifTag;->getComponentCount()I
    ...
    .line 712
    :cond_7
    invoke-virtual {p1, v7}, Lcom/android/mms/exif/ExifTag;->setValue([I)Z
...
.method protected readRational()Lcom/android/mms/exif/Rational;
    ...
    invoke-direct {v2, v3, v4, v5, v6}, Lcom/android/mms/exif/Rational;-><init>(JJ)V
...
.method protected readUnsignedRational()Lcom/android/mms/exif/Rational;
    ...
    invoke-direct {v4, v2, v3, v0, v1}, Lcom/android/mms/exif/Rational;-><init>(JJ)V
...
.method protected skipRemainingTagsInCurrentIfd()V
    ...
    iget-object v4, p0, Lcom/android/mms/exif/ExifParser;->mTiffStream:Lcom/android/mms/exif/CountedDataInputStream;

    invoke-virtual {v4}, Lcom/android/mms/exif/CountedDataInputStream;->getReadByteCount()I
    ...
    .line 369
    :cond_1
    iget-boolean v4, p0, Lcom/android/mms/exif/ExifParser;->mNeedToParseOffsetsInCurrentIfd:Z
    ...
    iput-object v4, p0, Lcom/android/mms/exif/ExifParser;->mTag:Lcom/android/mms/exif/ExifTag;

    .line 372
    add-int/lit8 v3, v3, 0xc

    .line 373
    iget-object v4, p0, Lcom/android/mms/exif/ExifParser;->mTag:Lcom/android/mms/exif/ExifTag;
    ...
    invoke-direct {p0, v4}, Lcom/android/mms/exif/ExifParser;->checkOffsetOrImageTag(Lcom/android/mms/exif/ExifTag;)V
    ...
    .line 386
    invoke-direct {p0, v6, v1, v2}, Lcom/android/mms/exif/ExifParser;->registerIfd(IJ)V
