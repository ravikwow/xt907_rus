...
.method public onCreateLoader(ILandroid/os/Bundle;)Landroid/content/CursorLoader;
    ...
    invoke-static {v1}, Lcom/android/contacts/list/ContactTileListFragment;->access$400(Lcom/android/contacts/list/ContactTileListFragment;)Lcom/android/contacts/list/ContactTileAdapter$DisplayType;
    ...
    # getter for: Lcom/android/contacts/list/ContactTileListFragment;->mDisplayType:Lcom/android/contacts/list/ContactTileAdapter$DisplayType;
    invoke-static {v2}, Lcom/android/contacts/list/ContactTileListFragment;->access$400(Lcom/android/contacts/list/ContactTileListFragment;)Lcom/android/contacts/list/ContactTileAdapter$DisplayType;
...
.method public onLoadFinished(Landroid/content/Loader;Landroid/database/Cursor;)V
    ...
    invoke-static {v0}, Lcom/android/contacts/list/ContactTileListFragment;->access$500(Lcom/android/contacts/list/ContactTileListFragment;)Lcom/android/contacts/list/ContactTileAdapter;
    ...
    invoke-static {v0}, Lcom/android/contacts/list/ContactTileListFragment;->access$700(Lcom/android/contacts/list/ContactTileListFragment;)Landroid/widget/TextView;
    ...
    invoke-static {v1}, Lcom/android/contacts/list/ContactTileListFragment;->access$600(Lcom/android/contacts/list/ContactTileListFragment;)Ljava/lang/String;
    ...
    invoke-static {v0}, Lcom/android/contacts/list/ContactTileListFragment;->access$800(Lcom/android/contacts/list/ContactTileListFragment;)Landroid/widget/ListView;
    ...
    # getter for: Lcom/android/contacts/list/ContactTileListFragment;->mEmptyView:Landroid/widget/TextView;
    invoke-static {v1}, Lcom/android/contacts/list/ContactTileListFragment;->access$700(Lcom/android/contacts/list/ContactTileListFragment;)Landroid/widget/TextView;
    ...
    # getter for: Lcom/android/contacts/list/ContactTileListFragment;->mNeedLoading:Z
    invoke-static {v0}, Lcom/android/contacts/list/ContactTileListFragment;->access$100(Lcom/android/contacts/list/ContactTileListFragment;)Z
    ...
    # getter for: Lcom/android/contacts/list/ContactTileListFragment;->mHandler:Landroid/os/Handler;
    invoke-static {v0}, Lcom/android/contacts/list/ContactTileListFragment;->access$900(Lcom/android/contacts/list/ContactTileListFragment;)Landroid/os/Handler;
    ...
    invoke-static {v0, v1}, Lcom/android/contacts/list/ContactTileListFragment;->access$002(Lcom/android/contacts/list/ContactTileListFragment;Z)Z
