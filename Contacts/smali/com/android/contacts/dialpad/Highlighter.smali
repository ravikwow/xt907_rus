.class public abstract Lcom/android/contacts/dialpad/Highlighter;
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/android/contacts/dialpad/Highlighter;->DBG:Z

    .line 44
    sget-boolean v0, Lcom/android/contacts/activities/DialtactsActivity;->VDBG:Z

    sput-boolean v0, Lcom/android/contacts/dialpad/Highlighter;->VDBG:Z
...
.method private static getHighlighter(Landroid/text/Spannable;)Lcom/android/contacts/dialpad/Highlighter;
    .locals 3
    ...
    .line 122
    .local v0, "highlighter":Lcom/android/contacts/dialpad/Highlighter;
    invoke-virtual {p0}, Ljava/lang/Object;->toString()Ljava/lang/String;

    move-result-object v2

    invoke-static {v2}, Lcom/android/contacts/dialpad/Highlighter;->guessFullNameStyle(Ljava/lang/String;)I
    ...
    .line 124
    sget-boolean v2, Lcom/android/contacts/dialpad/Highlighter;->DBG:Z

    if-eqz v2, :cond_0

    const-string v2, "it\'s Korean name."

    invoke-static {v2}, Lcom/android/contacts/dialpad/Highlighter;->log(Ljava/lang/String;)V

    .line 125
    :cond_0
    invoke-static {}, Lcom/android/contacts/dialpad/KoreanHighlighter;->getInstance()Lcom/android/contacts/dialpad/KoreanHighlighter;
    ...
    .line 128
    :cond_3
    invoke-static {}, Lcom/android/contacts/dialpad/ChineseHighlighter;->getInstance()Lcom/android/contacts/dialpad/ChineseHighlighter;
    ...
    .line 131
    :cond_5
    invoke-static {}, Lcom/android/contacts/dialpad/EnglishHighlighter;->getInstance()Lcom/android/contacts/dialpad/EnglishHighlighter;
...
.method private static guessCJKNameStyle(Ljava/lang/String;I)I
    ...
    invoke-static {v2}, Lcom/android/contacts/dialpad/Highlighter;->isJapanesePhoneticUnicodeBlock(Ljava/lang/Character$UnicodeBlock;)Z
    ...
    :cond_0
    invoke-static {v2}, Lcom/android/contacts/dialpad/Highlighter;->isKoreanUnicodeBlock(Ljava/lang/Character$UnicodeBlock;)Z
...
.method private static guessFullNameStyle(Ljava/lang/String;)I
    ...
    invoke-static {v4}, Lcom/android/contacts/dialpad/Highlighter;->isLatinUnicodeBlock(Ljava/lang/Character$UnicodeBlock;)Z
    ...
    .line 154
    invoke-static {v4}, Lcom/android/contacts/dialpad/Highlighter;->isCJKUnicodeBlock(Ljava/lang/Character$UnicodeBlock;)Z
    ...
    invoke-static {p0, v5}, Lcom/android/contacts/dialpad/Highlighter;->guessCJKNameStyle(Ljava/lang/String;I)I
    ...
    .line 160
    :cond_2
    invoke-static {v4}, Lcom/android/contacts/dialpad/Highlighter;->isJapanesePhoneticUnicodeBlock(Ljava/lang/Character$UnicodeBlock;)Z
    ...
    .line 164
    :cond_3
    invoke-static {v4}, Lcom/android/contacts/dialpad/Highlighter;->isKoreanUnicodeBlock(Ljava/lang/Character$UnicodeBlock;)Z
...
.method public static highlight(Landroid/text/Spannable;Ljava/lang/String;ZIII)V
    ...
    .line 51
    invoke-static {p0, p1, p3, p4, p5}, Lcom/android/contacts/dialpad/Highlighter;->numHighlight(Landroid/text/Spannable;Ljava/lang/String;III)V
    ...
    .line 53
    :cond_0
    invoke-static {p0}, Lcom/android/contacts/dialpad/Highlighter;->getHighlighter(Landroid/text/Spannable;)Lcom/android/contacts/dialpad/Highlighter;

    move-result-object v0

    invoke-virtual {v0, p0, p1, p4, p5}, Lcom/android/contacts/dialpad/Highlighter;->nameHighlight(Landroid/text/Spannable;Ljava/lang/String;II)V
...
.method private static numHighlight(Landroid/text/Spannable;Ljava/lang/String;III)V
    ...
    .line 70
    .local v5, "len":I
    invoke-static/range {p1 .. p1}, Lcom/android/contacts/dialpad/SmartDialerUtil;->hasDigitsChar(Ljava/lang/String;)Z
    ...
    invoke-static {v12}, Lcom/android/contacts/dialpad/SmartDialerUtil;->isSeparator(C)Z
